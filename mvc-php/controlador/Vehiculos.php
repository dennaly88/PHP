<?php
	...
	class VehiculosController {
		...
		public function __construct(){
			require_once "modelos/VehiculosModel.php";
		}
		...
		public function index(){
			...
			require_once "vistas/vehiculos/vehiculos.php";	
		}
		
		public function nuevo(){
			
			$data["titulo"] = "Vehiculos";
			require_once "vistas/vehiculos/vehiculos_nuevo.php";
		}
		...
		public function modificar($id){
			...
			$data["titulo"] = "Vehiculos";
			require_once "vistas/vehiculos/vehiculos_modifica.php";
		}
